...
ORS_PBF := $(ORS_DATA_DIR)/files/stuttgart-regbez-latest.osm.pbf
ORS_PBF_URL := https://download.geofabrik.de/europe/germany/baden-wuerttemberg/stuttgart-regbez-latest.osm.pbf
...
.PHONY: help doctor dirs segments ors-data build up setup smoke smoke-ors test validate logs status down restart
